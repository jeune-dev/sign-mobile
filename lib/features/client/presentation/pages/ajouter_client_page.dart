...
class _AjouterClientPageState extends State<AjouterClientPage> {
  ...
  InputDecoration _dec(String hint, IconData icon, {Widget? suffix}) {
    return InputDecoration(
      hintText: hint,
      hintStyle: const TextStyle(fontSize: 14, color: AppColor.kTexteFaible),
      prefixIcon: Icon(icon, size: 18, color: AppColor.kTexteMoyen),
      suffixIcon: suffix,
      filled: true,
      ...
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(14),
        borderSide: const BorderSide(color: AppColor.kBordure),
      ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _card(children: [
                      ...
                      _label('Numéro de pièce d’identité'),
                      TextFormField(
                        controller: _cinController,
                        decoration: _dec('CNI ou passeport', Icons.credit_card_outlined),
                      ),
                    ]),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              ...
                              style: AppTypo.jakarta(fontSize: 12, color: const Color(0xFF15803D)),
                            ),
                          ),
                        ],
                      ),
                            ...
                            : Row(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: AppTypo.jakarta(fontSize: 15, fontWeight: FontWeight.w700),
                                  ),
                                  const SizedBox(width: 8),
