...
import 'package:sign_application/features/quittance_loyer/domain/usecases/telecharger_quittance.dart';
...
class _CreationQuittancePageState extends State<CreationQuittancePage> {
  ...
  /// Décoration déléguée au composant partagé : un champ de quittance est
  /// identique à un champ de contrat ou d'inscription.
  InputDecoration _dec(String hint, {IconData? icon, Widget? suffix}) =>
      AppChampTexte.decoration(indication: hint, icone: icon, suffixe: suffix);

  Widget _label(String text, {bool req = false}) => Padding(
    padding: const EdgeInsets.only(bottom: 7),
    child: Row(children: [
      Text(text, style: AppTypo.jakarta(fontSize: 13, fontWeight: FontWeight.w600, color: AppColor.kTexte)),
      if (!req) ...[
        const SizedBox(width: 8),
        Text('facultatif',
            style: AppTypo.jakarta(
                fontSize: 11.5, fontWeight: FontWeight.w500, color: AppColor.kTexteFaible)),
      ],
    ]),
  );
      ...
      return Expanded(
        child: GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: active ? AppColor.kTexte : Colors.transparent,
            ...
            child: Text(
              ...
              style: AppTypo.jakarta(
                ...
                color: active ? Colors.white : AppColor.kTexteMoyen,
              ),
            ),
          ),
        ),
    ...
    return Row(
      ...
      children: [
        Expanded(
          child: Text(label,
              style: AppTypo.jakarta(
                  fontWeight: FontWeight.w600, fontSize: 13, color: AppColor.kTexte)),
        ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppEnteteFormulaire.barre(
        titre: 'Nouvelle quittance',
        sousTitre: 'Locataire, période et montant du loyer',
      ...
      body: BlocListener<QuittanceLoyerBloc, QuittanceLoyerState>(
        listener: (context, state) {
          if (state is QuittanceLoyerSuccess) {
            ...
            // La quittance est montree a l'utilisateur avant tout retour a
            ...
            afficherDocumentGenere(
              ...
              telecharger: (id) async {
                final resultat = await sl<TelechargerQuittance>()(id);
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                SectionEmetteur(controleur: _emetteur, titre: 'Vos informations (bailleur)'),
                                  ...
                                  child: Row(children: [
                                    ...
                                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      if (client.email != null)
                                        Text(client.email!, style: const TextStyle(fontSize: 12, color: AppColor.kTexteMoyen)),
                                    ])),
                                    const Icon(Icons.arrow_forward_ios_rounded, size: 12, color: AppColor.kTexteFaible),
                                  ]),
                                ),
                              )).toList(),
                            ),
                ...
                _card(children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: AppTypo.jakarta(fontWeight: FontWeight.w600, fontSize: 12.5, color: AppColor.kTexte),
                          ),
                        ],
                      ),
                    ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Row(children: [
                          const Icon(Icons.check_circle_outline_rounded, color: AppColor.kTexte, size: 18),
                          const SizedBox(width: 8),
                          Text('Montant total', style: AppTypo.jakarta(fontWeight: FontWeight.w600, fontSize: 13, color: AppColor.kTexte)),
                        ]),
                        Text(
                          '${_montantFmt.format(_montantTotal).replaceAll(',', ' ')} FCFA',
                          style: AppTypo.jakarta(fontWeight: FontWeight.w800, fontSize: 16, color: AppColor.kTexte),
                        ),
                      ],
                    ),
                  ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppColor.kChamp,
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: _datePaiement != null ? AppColor.kTexte : AppColor.kBordure, width: _datePaiement != null ? 1.5 : 1),
                      ),
                      child: Row(children: [
                        Icon(
                          Icons.calendar_today_outlined,
                          size: 18,
                          color: _datePaiement != null ? AppColor.kTexte : AppColor.kTexteFaible,
                        ),
                        const SizedBox(width: 10),
                        Text(
                        ...
                        const Spacer(),
                        const Icon(Icons.arrow_drop_down_rounded, color: AppColor.kTexteMoyen),
                      ]),
                    ),
                  ),
                  const SizedBox(height: 14),
                  ...
                  Container(
                    ...
                    child: Material(
                      ...
                      child: SwitchListTile(
                        ...
                        title: Text('Paiement complet', style: AppTypo.jakarta(fontWeight: FontWeight.w600, fontSize: 14)),
                        subtitle: Text(
                    ...
                    child: Container(
                      ...
                      child: _signatureImage != null
                          ...
                          : const Column(
                              ...
                              children: [
                                Icon(Icons.gesture_rounded, color: AppColor.kTexteFaible, size: 28),
                                SizedBox(height: 6),
                                Text('Touchez pour signer', style: TextStyle(color: AppColor.kTexteMoyen, fontSize: 12)),
                              ],
                            ),
                    ),
                  ),
                  if (_signatureImage != null) ...[
                    ...
                    Align(
                      ...
                      child: TextButton.icon(
                        ...
                        icon: const Icon(Icons.refresh_rounded, size: 16, color: AppColor.kTexteMoyen),
                        label: const Text('Recommencer', style: TextStyle(color: AppColor.kTexteMoyen, fontSize: 12)),
                      ),
                    ),
                  ],
                ]),
                      ...
                      child: ElevatedButton(
                        ...
                        child: isLoading
                            ...
                            : Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                Text('Générer la quittance', style: AppTypo.jakarta(fontSize: 15, fontWeight: FontWeight.w700)),
                                const SizedBox(width: 8),
